...
import com.example.mitienda.ClassAux.ImprimirVale;
import com.example.mitienda.ClassAux.SizeColumnTable;
import com.example.mitienda.Data.*;
import com.example.mitienda.Model.*;
...
public class ControllerVenta implements Initializable {
    ...
    public void llenarTablaDisponible (){
        DataProductoDisponible pro=new DataProductoDisponible();
        listaProducto.clear();
    ...
    public  void numeroOrder(){
        DataProductoDisponible dataProDisponible=new DataProductoDisponible();
    ...
    public void RealizarVenta(ActionEvent actionEvent) {
        ...
        if (!cbxCliente.getSelectionModel().isEmpty()) {
            ...
            DataModelo_factura modelo=new DataModelo_factura();

...
import com.example.mitienda.Controller.ControllerCliente;
...
public class CellCliente extends ListCell<Cliente> {
    ...
    public CellCliente(){
        FXMLLoader loader=new FXMLLoader(getClass().getResource("/View/Cliente/RowCliente.fxml"));
        try {
            graphic=loader.load();
        }catch (IOException e){
            e.printStackTrace();
        ...
        rowCliente.btnEliminar.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (alertDialog.alertConfirm("View/Cliente", "esta seguro de elliminar el cliente")){
        ...
        rowCliente.btnEditar.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/Cliente/FormCliente.fxml"));

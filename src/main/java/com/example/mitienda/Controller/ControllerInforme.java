...
import com.example.mitienda.Data.DataProductoVendido;
import com.example.mitienda.Data.DataVenta;
...
public class ControllerInforme implements Initializable {
    ...
    public void accionRadioButtons(){
        rDia.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                VerCierreVenta(new Venta(0,obtnerfechaHoy(),obtnerfechaHoy()),"dia","gdia");
                listVendido= FXCollections.observableArrayList(vendido.viewProductoVendido(new Venta(0,obtnerfechaHoy(),obtnerfechaHoy()),"hoy"));
        ...
        rSemana.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                VerCierreVenta(new Venta(0,obtnerfechaHoy(),obtnerfechaHoy()),"semana","gsemana");
                listVendido=FXCollections.observableArrayList(vendido.viewProductoVendido(new Venta(0,obtnerfechaHoy(),obtnerfechaHoy()),"semana"));
        ...
        rMes.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                VerCierreVenta(new Venta(0,obtnerfechaHoy(),obtnerfechaHoy()),"mes","gmes");
                listVendido=FXCollections.observableArrayList(vendido.viewProductoVendido(new Venta(0,obtnerfechaHoy(),obtnerfechaHoy()),"mes"));
                rSemana.setSelected(false);
                rDia.setSelected(false);
            }
        });
        btnVer.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                VerCierreVenta  (new Venta(0,fe_inicial,fe_final),"rango","grango");
                listVendido=FXCollections.observableArrayList(vendido.viewProductoVendido(new Venta(0,fe_inicial,fe_final),"rango"));
    ...
    public void  VerCierreVenta(Venta ventas,String accion, String gaccion){
        DataVenta dataVentas=new DataVenta();
    ...
    public void producto_mas_vendido(ActionEvent actionEvent) {
        try{
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/Informe/ProMasVendido.fxml"));
            Parent parent = loader.load();
            Stage stage=new Stage();
            stage.setScene(new Scene(parent));
            stage.getIcons().add(new Image("/img/icon.png"));
            ControllerProMasVendido producto_mas_vendido = loader.<ControllerProMasVendido>getController();
